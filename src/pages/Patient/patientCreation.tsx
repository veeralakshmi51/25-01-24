...
const PatientCreation: React.FC = () => {
  ...
  const handleSaveClick = async (e: React.FormEvent) => {
    ...
    if (
      ...
      !formValues.city ||
      //!formValues.state && formValues.state! =='defaultstate' ||
    ...
    <div className="row w-100">
      ...
      <div className="col-md-8">
        ...
        <div className="row w-100">
          ...
          <div className="col-md-4 mb-2">
            <TextField
              ...
              fullWidth
              onChange={(e) =>
                setFormValues({ ...formValues, mrNumber: e.target.value })
              }
            />
          </div>
        </div>
        ...
        <div className="row w-100 ">
          ...
          <div className="col-md-4 mb-2">{renderDropdown("state")}</div>
          <div className="col-md-4 mb-2">
            <TextField
              id="outlined-basic-3"
        ...
        <div className="row w-100 ">
          <div className="col-md-6 mb-2">{renderDropdown("country")}</div>
          <div className="col-md-6 mb-2">
            <TextField
              id="outlined-basic-2"
              label="DeviceId"
