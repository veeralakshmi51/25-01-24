 ...
 const handlePasswordVisibility = () => {
  ...
  return (
    <div className="d-flex vh-100">
      ...
      <div className="col-md-5 d-flex flex-column align-items-center justify-content-md-center p-0">
      ...
      <TextField
        ...
        InputProps={{
          startAdornment: (<InputAdornment position="start"><Lock style={{ color: 'darkblue' }} /></InputAdornment>),
          endAdornment: (
